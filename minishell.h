...
/*   Updated: 2024/11/22 00:54:15 by ansebast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void							update_envvar(t_env **env, char *var,
									char *value);
char							*expand_variables(const char *str,
									t_command *cmd, int *arg_pos, t_env **env);
...
t_command						*add_command(t_command **commands,
									const char *command);
