...
#    Updated: 2025/01/09 05:42:13 by ansebast         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRCS = echo.c env_utils.c expand_variables.c handle_output_redirection.c print_utils.c unset.c \
	builtins_utils.c env.c execute_commands.c export.c handle_pipe_stdin.c minishell.c pwd.c \
	cd.c env_utils2.c exec_builtin_exec_external.c find_path_prepare_args.c handle_redirection.c minishell_utils.c tokenize.c \
